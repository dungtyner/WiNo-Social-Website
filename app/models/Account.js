...
const Account = mongoose.Schema(
    {
        ...
        avatar_account:{type: String, required: false, default:'https://drive.google.com/uc?export=view&id=1ONQ1Mdw14u4gMRyHZSd37cbmfSH-UYlX'},
        cover_image:{type: String,required: false, default:'https://drive.google.com/uc?export=view&id=1VPH0o0V7iK07TWE4mQwOwcdzOVPYvjxd'},
...
async function getDataAccount_bySlug(slug_personal){
    var data = await mongoose.model("Account",Account).findOne({slug_personal})
    return data 
    }
module.exports={Account:mongoose.model("Account",Account),getDataAccount_byID, getDataAccount_bySlug};
