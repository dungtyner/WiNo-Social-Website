...
router.post('/saveMessage',global.uploads.array('listFile'),chatController.request_saveMessage)
...
router.get('/clearNotificationChat',chatController.request_clearNotificationChat)
