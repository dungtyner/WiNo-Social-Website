...
router.get('/getListResponseFriend',friendController.req_getListResponseFriend)

router.get('/list/:slug_personal*',accountController.getPersonalPageWithSlug)
router.get('/request/:slug_personal*',accountController.getPersonalPageWithSlug)
router.get('/response/:slug_personal*',accountController.getPersonalPageWithSlug)


router.post('/requestAddFriend',friendController.requestAddFriend)
router.post('/remove_requestAddFriend',friendController.remove_requestAddFriend)
router.post('/refuse_requestAddFriend',friendController.refuse_requestAddFriend)
