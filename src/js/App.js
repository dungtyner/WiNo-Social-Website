    ...
    useEffect(() => {
        if (isLoginEd === 200) {
            ...
            state.socketChat.on(
                ...
                (data) => {
                    if (
                        result.account.slug_personal !=
                        data.account_caller.slug_personal
                    ) {
                        dispatch(
                            add_popup_call_video(
                                <PopUpCallVideo
    ...
    useEffect(() => {
        if (state.account.list_slug_friend) {
            state.account.list_slug_friend.forEach((slug_friend) => {
                ...
                state.socket.once(
                    `FRIEND_${slug_friend}_ONLINE`,
                    (my_friend) => {
                        dispatch(add_friend_online(my_friend));
                    }
                );
                state.socket.once(
                    `FRIEND_${slug_friend}_OFFLINE`,
                    (my_friend) => {
                                                    ...
                                                    <Route
                                                        ...
                                                        element={
                                                            <PagePersonal
                                                                ...
                                                                elContent={
                                                                    <SubContentPersonal data="Header" />
                                                                }
                                                            />
                                                        }
                                                    >
