...
import {Box, ButtonGroup, Modal,Stack, TextField, Typography,Input} from "@mui/material";
        ...
        <Card sx={{ m: 3 }}>
          ...
          >
            ...
            >
              ...
              <Typography variant="h6" color={"gray"} textAlign={"center"}  sx={{ borderBottom:"1px solid green", paddingBottom:"20px", marginBottom:"10px" }}>
                Create Post
              </Typography>
              ...
              <Stack direction={"row"} gap={1} mt={3} mb={2} sx={{}}>
                <IconButton aria-label="emoji" onClick={() =>setShowPicker(val => !val)}>
                  <EmojiEmotions
                    color="primary"
                ...
                <IconButton aria-label="image" onClick={() => imageRef.current.click()} >
                  <Image
                    color="secondary"
              ...
              {/* <FormTagFriend
                ...
                >         
                  ...
                  sx={{  }}
                  >
                  <IconButton  sx={{position:"absolute",  backgroundColor:"rgb(221, 221, 221)"}}>
                  ...
                  <Input  
                    sx={{ width: "85%", backgroundColor:"rgb(221, 221, 221)", borderRadius:"50px", paddingLeft:"20px"}}
                    id="standard-multiline-static"
                    multiline
                    rows={1}
                  ...
                  />       
                    ...
                    <Button sx={{ position:"relative", justifyContent:"center",alignItems:"center" }}
                    >OK</Button>
