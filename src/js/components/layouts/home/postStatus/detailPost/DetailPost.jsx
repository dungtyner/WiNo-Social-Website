...
function DetailPost(props) {
    ...
    return (
        <div className="container_detail_post">
            <Box width={1000} bgcolor={"gray"} color={"text.primary"}
                    ...
                    <div className="display_like_post_content">
                        <div className="action_post_body">
                            <div className="left_action">
                                {status_like ? <IconButton> <Favorite onClick={()=>{
                                    handler_UnTym();
                                }} style={{ fontSize: '30px', cursor: 'pointer', color: 'red' }}/></IconButton>  :
                                    <IconButton>
                                    <FavoriteBorder 
                                      onClick={()=>{
                                        handler_Tym();
                        ...
                        <span className="count_users_liked" style={{ fontWeight: '600', cursor: 'pointer' }}
                            // data-toggle="modal"
                            // data-target={`#${id_image_post}_like`}
                            onClick={(event) => { setOpenLiker(true)}}
                        >{post.like} like</span>
                        ...
                        <div className="card_create_post_details">
                                ...
                                >
                                  <Box width={500} bgcolor={"background.default"} 
                                    p={3} borderRadius={4} height={400} sx={{ overflow:'auto' }}>
                                    <span onClick={(event) => {setOpenLiker(false); }}>
                                    ...
                                    <div className="modal-body">
                                        {
                                            users_like && users_like.map(value => (
                                                ...
                                                <Avatar sx={{ border: '2px solid #4de739' }} src={value.avatar_account_following_following}/>
                                                    <div className="name_user_fav">
                                                        <span style={{ paddingLeft:'10px', fontWeight:"600" }}>{value.username}</span>  
                                                    </div>   
                                            </div>
                                            ))
                                        }
                ...
                <div className="group_content_detail_post_right">
                    ...
                    <div className="header_detail_post">
                        <div className='detail_info_user'>
                            ...
                            />  
                            <span className="" style={{ fontWeight: '600', paddingLeft:"10px" }}>{user.username_following}</span>
                        </div>
                        {
                           ...
                           <div className="card_create_post_details">
                                ...
                                >
                                  <Box width={500} bgcolor={"background.default"} color={"text.primary"}
                                    ...
                                    {
                                        navigate && <Navigate to={`/account/personal/${state.account.slug_personal}`} />
                                    }
                                    <Button variant="outlined" color="error" onClick={(event) => {setOpen(false); }}>
                                      No
                                    </Button>
                                    </div>
