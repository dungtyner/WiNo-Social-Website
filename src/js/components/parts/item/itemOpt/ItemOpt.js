    ...
    >
      <div className={ItemOptStyles["main-itemOpt"]}>
        <div className={ItemOptStyles["body-itemOpt"]}>
          ...
          {component_Left ? <div className={ItemOptStyles["childrenLeft-itemOpt"]}>
            {component_Left}
            
            </div> : ""
            
          }
          {children_centerItemOpt ? <div className={ItemOptStyles["childrenCenter-itemOpt"]}>{children_centerItemOpt}</div> : ""}
          </div>
          <div className={ItemOptStyles["center-itemOpt"]}>
          {/* {el_subTextItem ? <div className={ItemOptStyles["subText-itemOpt"]}>{el_subTextItem}</div> : ""} */}
          </div>
        {component_Right ? <div className={ItemOptStyles["summary-itemOpt"]}>{component_Right}</div> : ""}
        </div>
        {component_Sub ? <div className={ItemOptStyles["sub-itemOpt"]}>{component_Sub}</div>:''}
