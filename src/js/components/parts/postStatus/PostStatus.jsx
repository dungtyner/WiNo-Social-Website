...
import {Checkbox, Input, Box, TextField, Button,ButtonGroup} from "@mui/material";
...
const onEmojiClick = (event, emojiObject) => {
  ...
  // setShowPicker(false);
    ...
    return (<Card sx={{
        ...
        <CardActions disableSpacing sx={{ borderBottom:"1px solid rgb(221, 221, 221)", marginBottom:"20px"}}>
